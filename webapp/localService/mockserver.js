				...
				if (navigationProperty && entityType) {
					...
					navPropData.forEach(function (iteratedDataPoint) {
						...
						for (i = 0; i < referentialConstraints.length; i++) {
							...
							if ((multiplicity && iteratedDataPoint[dependentProperty] !== dataPoint[principalProperty]) || !multiplicity && dataPoint[dependentProperty] !== iteratedDataPoint[principalProperty]) {
								res = false;
							}
						}
